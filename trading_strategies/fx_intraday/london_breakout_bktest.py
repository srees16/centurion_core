...
def plot(new):
    ...
    ax.plot(new.index, new['price'], label='price')
    ...
    plt.axvline(pd.to_datetime('%s 03:00:00'%(date)),linestyle=':',c='k')
    plt.axvline(pd.to_datetime('%s 12:00:00'%(date)),linestyle=':',c='k')
    ...
    bx.plot(news.index, news['price'], label='price')
